...
Package.onUse(function(api) {
  ...
  api.use('silentcicero:ethereumjs-accounts@0.0.15', 'client');
  ...
  api.use('ethereum:accounts@0.3.4', 'client');
  api.imply('ethereum:accounts@0.3.4', 'client');

  api.export(['PocketBook'], 'client');

  api.addFiles('lib/pocketbookConfig.js', 'client');
  api.addFiles('account.html', 'client');
  api.addFiles('account.js', 'client');
